  ...
  render() {
    return (
      <S.MainContentWrapper>
        ...
        <S.Content>
          ...
          <S.Description>
            ...
            <p>
              ...
              ferramenta para o bem-estar físico e mental. Por isso, nosso
              ensino é orientado não só para a evolução técnica, mas também para
              a promoção da saúde. Através da conexão com o corpo e da interação
        ...
        <S.SectionTitle>Aulas com Foco Técnico</S.SectionTitle>
        <S.CulturalSection>
          <S.Description>
            <p>
            ...
            <p>
              ...
              organizada, sempre alinhados com o ritmo da música e em sintonia
              com o par, garantindo que a dança flua de maneira natural e
              prazerosa.
            </p>
            <p>
              Os professores têm como prioridade ajudar os alunos a entenderem
              bem a base técnica, para que cada um consiga evoluir de forma
              segura e confiante. O resultado é uma dança mais conectada, onde
              os movimentos seguem o ritmo da música e a energia do par,
              tornando a experiência ainda mais enriquecedora e divertida.
            </p>
          </S.Description>
          <img
            className='img-sobre'
